...
The repo for this support is located `here <https://github.com/dbosoft/IdentityServer.AspNetIdentity/>`_ and the NuGet package is `here <https://www.nuget.org/packages/IdentityServer4.AspNetIdentity>`_.
