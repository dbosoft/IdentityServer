...
The code for this library is located `here <https://github.com/dbosoft/IdentityServer/tree/main/src/EntityFramework>`_ (with the underlying storage code `here <https://github.com/dbosoft/IdentityServer/tree/main/src/EntityFramework.Storage>`_) and the NuGet package is `here <https://www.nuget.org/packages/IdentityServer4.EntityFramework>`_.
...
We also publish `sample SQL scripts <https://github.com/dbosoft/IdentityServer/tree/main/src/EntityFramework.Storage/migrations/SqlServer/Migrations>`_ for the current version of the database schema.
