...
or use the `identity server authentication handler <https://github.com/dbosoft/IdentityServer.AccessTokenValidation>`_ which can validate both JWTs and reference tokens.
