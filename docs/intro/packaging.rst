...
^^^^^^^^^^^^^^^
`github <https://github.com/dbosoft/IdentityServer>`_
...
Quickstart UI
^^^^^^^^^^^^^
`github <https://github.com/dbosoft/IdentityServer.Quickstart.UI>`_

Contains a simple starter UI including login, logout and consent pages.

Access token validation handler
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
`nuget <https://www.nuget.org/packages/IdentityServer4.AccessTokenValidation>`_ | `github <https://github.com/dbosoft/IdentityServer.AccessTokenValidation>`_
...
Templates
^^^^^^^^^
`nuget <https://www.nuget.org/packages/IdentityServer4.Templates>`_ | `github <https://github.com/dbosoft/IdentityServer.Templates>`_
