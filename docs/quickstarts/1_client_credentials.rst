...
Source Code
^^^^^^^^^^^
As with all of these quickstarts you can find the source code for it in the `IdentityServer4 <https://github.com/dbosoft/IdentityServer/blob/main/samples>`_ repository. The project for this quickstart is `Quickstart #1: Securing an API using Client Credentials <https://github.com/dbosoft/IdentityServer/tree/main/samples/Quickstarts/1_ClientCredentials>`_
...
(see the full file `here <https://github.com/dbosoft/IdentityServer/blob/main/samples/Quickstarts/1_ClientCredentials/src/IdentityServer/Config.cs>`_).
...
^^^^^^^^^^^^^^^^^^^^^^^^^^
Loading the resource and client definitions happens in `Startup.cs <https://github.com/dbosoft/IdentityServer/blob/main/samples/Quickstarts/1_ClientCredentials/src/IdentityServer/Startup.cs>`_ - update the code to look like this::
...
Configure the API application to run on ``https://localhost:6001`` only. You can do this by editing the `launchSettings.json <https://github.com/dbosoft/IdentityServer/blob/main/samples/Quickstarts/1_ClientCredentials/src/Api/Properties/launchSettings.json>`_ file inside the Properties folder. Change the application URL setting to be::
...
(full file can be found `here <https://github.com/dbosoft/IdentityServer/blob/main/samples/Quickstarts/1_ClientCredentials/src/Client/Program.cs>`_)
